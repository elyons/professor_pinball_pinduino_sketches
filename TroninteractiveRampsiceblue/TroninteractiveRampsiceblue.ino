...
int aLEDNum2 = 85; // yellow light cycle, ramp entrance on right; exit on left
int aLEDNum3 = 0;
...
//    pd.adrLED1()->bullet2Color("black", "iceblue", 16, 0, 1);
  ...
  if ( pd.pinState()->J6(1) & pd.pinState()->J7(8) ) { // light cycle
    ...
    pd.adrLED1()->bullet2Color("iceblue", "iceblue", 20, 0, -1);
    led1Color="yellow";
    led2Color="iceblue";
    trigger =1;    
  }
...
//   if (pd.pinState()->J6(2) && pd.pinState()->J6(3) && pd.pinState()->J6(7) && pd.pinState()->J6(8) 
   if (pd.pinState()->J6(2) && pd.pinState()->J6(3) 
     //&& ! pd.pinState()->J7(4) && ! pd.pinState()->J7(8) && ! pd.pinState()->J7(9) 
      ...
      pd.adrLED2()->spreadInFromPoint(aLEDNum2, "iceblue", 1);
      delay (400);
...
void backgroundChase() {
    ...
    if (random(1000) == 0) {
      ...
      pd.adrLED1()->bullet2Color("purple", "iceblue", 50, 0, -1);
      for (int i=0; i<500; i=i+1){
       checkPinStates();
      }
    }
